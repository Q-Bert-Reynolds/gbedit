...
PITCH_PATH_TOSS     EQU 2
PITCH_PATH_FADE     EQU 3
PITCH_PATH_SLIDER   EQU 4
PITCH_PATH_CURVE    EQU 5
PITCH_PATH_RISE     EQU 6
PITCH_PATH_DROP     EQU 7
PITCH_PATH_EEPHUS   EQU 8
PITCH_PATH_KNUCKLE  EQU 9
PITCH_PATH_SCREW    EQU 10
PITCH_PATH_SLURVE   EQU 11
