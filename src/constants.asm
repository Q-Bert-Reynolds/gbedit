...
ITEM_TYPE_DNA       EQU 2
ITEM_TYPE_EVOLUTION EQU 3
ITEM_TYPE_GAME      EQU 4
ITEM_TYPE_MOVE      EQU 5
ITEM_TYPE_POWERUP   EQU 6
ITEM_TYPE_SPECIAL   EQU 7
ITEM_TYPE_STATUS    EQU 8
ITEM_TYPE_UNLISTED  EQU 9
ITEM_TYPE_SELL      EQU 10
ITEM_TYPE_WORLD     EQU 11
